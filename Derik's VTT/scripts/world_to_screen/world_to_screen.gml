...
/*
	...
	www.thesnidr.com
*/
function world_to_screen(argument0, argument1, argument2) {

	var xx = argument0.x;
	var yy = argument0.y;
	var zz = argument0.z;
	var view_mat = argument1;
	var proj_mat = argument2;
	...
	return new vec2((0.5 + 0.5 * cx) * window_get_width(), (0.5 + 0.5 * cy) * window_get_height());
